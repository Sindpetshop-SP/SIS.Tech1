...
select * from Formulario where CodFormulario = 16
select * from Controle where CodFormulario = 16
select * from Sistema_Perfil_Controle where CodControle in(select CodControle from Controle where CodFormulario = 16)
select * from Sistema_Usuario_Controle where CodControle in(select CodControle from Controle where CodFormulario = 16)
...
begin tran
	...
	insert into Formulario values(@codSistema, 'HistConvencao','Tela de Histórico CCT', 'cd0001', getdate(), 'cd0001', getdate())
