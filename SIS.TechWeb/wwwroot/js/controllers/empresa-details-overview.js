...
document.addEventListener('DOMContentLoaded', function (e) {
  ...
  const dt_user_table_func = document.querySelector('.datatables-funcionario');
  const dt_user_table_soc = document.querySelector('.datatables-socio');

  // Users datatable FUNCIONARIO
  if (dt_user_table_func) {

    const dt_user = new DataTable(dt_user_table_func,
      {
        select: {
          style: 'multi',
  ...
  // Users datatable
  if (dt_user_table_soc) {

    const dt_user = new DataTable(dt_user_table_soc,
      {
        select: {
          style: 'multi',
          selector: 'td:nth-child(2)'
