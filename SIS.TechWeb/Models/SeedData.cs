...
namespace SIS.Tech.Models
{
    public static class SeedData
    {
        ...
        {
            //using (var context = new SIS.TechContext(
            //    serviceProvider.GetRequiredService<DbContextOptions<SIS.TechContext>>()))
            //{
            //    if (context == null || context.Transactions == null)
            //    {
            //        throw new ArgumentNullException("Null SIS.TechContext");
            //    }
